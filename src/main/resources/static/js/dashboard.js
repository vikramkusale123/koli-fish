...
try {
    ...
    createCustomerAreaChart(customers);
...
function createCustomerAreaChart(customers) {


const canvas =
    document.getElementById("customerAreaChart");
...
if (window.customerAreaChartInstance) {

    window.customerAreaChartInstance.destroy();
...
if (Array.isArray(customers)) {
    ...
    customers.forEach(function (customer) {
        ...
        if (
            ...
            areaCustomers[areaName] = 0;

        }


        areaCustomers[areaName]++;
...
if (entries.length > 5) {
    ...
    values.push(otherCustomers);

}


/* ===============================
   CREATE CUSTOMER DOUGHNUT
=============================== */

window.customerAreaChartInstance =
    new Chart(canvas, {
